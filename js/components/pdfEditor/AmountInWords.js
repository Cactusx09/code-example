...
const mapOrders = [
    ...
    {
        _Gender: false,
        _arrStates: ["тисяча", "тисячі", "тисяч"]
    },
    {
        _Gender: true,
        _arrStates: ["мільйон", "мільйона", "мільйонів"]
    },
    {
        _Gender: true,
        _arrStates: ["мільярд", "мільярда", "мільярдів"]
    },
    {
        _Gender: true,
        _arrStates: ["триліон", "триліона", "триліонів"]
    }
];
...
let valueAmountInWords = ((number) => {
    const Value = ((dVal, bGender) => {
    ...
    const From0To999 = ((fValue, oObjDesc, fnAddNum, fnAddDesc) => {
        let nCurrState = 2;
    ...
    const FloatToSamplesInWordsUkr = ((fAmount) => {
        ...
        const PushToRes = (strVal => arrRet.push(strVal));
...
export default valueAmountInWords;
